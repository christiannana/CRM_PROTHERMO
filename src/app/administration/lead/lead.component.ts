...
import { AjoutClientComponent, } from 'src/app/Module-Client-Particulier/statut-lead/statut-lead.component';
...
export class LeadComponent implements OnInit {
  ...
  onGetClients() {
    this.serviceAdmin.onGet_liste_des_clients_Lead().then(async (res) => {
