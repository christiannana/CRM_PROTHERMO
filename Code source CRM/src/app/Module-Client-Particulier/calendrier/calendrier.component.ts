...
export class CalendrierComponent implements OnInit {
  ...
  constructor(private modal: NgbModal, public alert: POPUPServiceService, public agentService: ApiAgentService,) { }
  ...
  onGet_list_RendezVous() {
    this.agentService.onGet_liste_des_RendezVous_Calendrier(localStorage.getItem('user_id')).then(async (res) => {
      ...
      console.log(this.datas_rendezVous);
        ...
        this.datas_rendezVous[i].title = this.datas_rendezVous[i].commentaire + ' à ' + this.datas_rendezVous[i].heure_rdv +' H';
